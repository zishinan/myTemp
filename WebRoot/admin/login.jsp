			...
			<TR>
				<TD align=middle>
					<TABLE cellSpacing=0 cellPadding=0 width=468 border=0>
						<TR>
							<TD><IMG height=23 src="<%=basePath%>images/login_1.jpg"
								width=468></TD>
						</TR>
						<TR>
							<TD><IMG height=147 src="<%=basePath%>images/login_2.jpg"
								width=468></TD>
						</TR>
					</TABLE>
					<TABLE cellSpacing=0 cellPadding=0 width=468 bgColor=#ffffff
						...
						<TR>
							<TD width=16><IMG height=122
								src="<%=basePath%>images/login_3.jpg" width=16></TD>
							<TD align=middle>
								<TABLE cellSpacing=0 cellPadding=0 width=230 border=0>
									...
									<TR height=36>
										...
										<TD><INPUT
											style="BORDER-RIGHT: #000000 1px solid; BORDER-TOP: #000000 1px solid; BORDER-LEFT: #000000 1px solid; BORDER-BOTTOM: #000000 1px solid"
											type=password maxLength=30 size=24 value="" name=userPwd></TD>
									</TR>
									<TR height=5>
										<TD colSpan=3></TD>
									</TR>
									<TR>
										...
										<TD><INPUT type=image height=18 width=70
											src="<%=basePath%>images/bt_login.gif"></TD>
									</TR>
								</TABLE>
							</TD>
							<TD width=16><IMG height=122
								src="<%=basePath%>images/login_4.jpg" width=16></TD>
						</TR>
